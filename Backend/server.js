...
app.use(cors({
    origin: 'http://127.0.0.1:3000', // Dashboard origin
...
app.use(
    session({
      ...
      store: MongoStore.create({
        mongoUrl: 'mongodb://localhost:27017/your-database-name', // MongoDB URI
        collectionName: 'sessions',
      }),
      cookie: {
        maxAge: 6 * 24 * 60 * 60 * 1000, // Session expires after 6 days
